    ...
    extends Mage_Core_Helper_Data
{
    ...
    const XPATH_DATA_KEY                    = 'giveit/settings/data_key';
    const XPATH_IS_MODULE_ENABLED           = 'giveit/settings/enabled';
    const XPATH_IS_CREATE_API_ORDER_ENABLED = 'giveit/settings/enabled_api_orders';
    ...
    public function getSdkOption($id, $type, $name, $optional = array())
    {
        ...
        return Mage::getModel('giveit/option', $options);
    }
    ...
    public function getSdkChoice($id, $name, $price, $optional = array())
    {
        ...
        return Mage::getModel('giveit/choice', $options);
    }
