    ...
    extends Mage_Core_Block_Template
{
    ...
    {
        return Mage::getSingleton('giveit/giveIt');
    }
    ...
    protected function _renderButton()
    {
        ...
        $buttonType = Mage::getStoreConfig('giveit/button_settings/button_color');
        ...
        if ($product->getId() && $product->isSalable()) {
            ...
            switch ($typeId) {
                case Mage_Catalog_Model_Product_Type::TYPE_SIMPLE:
                    $sdkProduct = Mage::getModel('giveit/product_type_simple');
                    $sdkProduct->setProductDetails(array($product));
                    break;
                case Mage_Catalog_Model_Product_Type::TYPE_CONFIGURABLE:
                    $sdkProduct = Mage::getModel('giveit/product_type_configurable');
                    $sdkProduct->setProductDetails(array($product));
                    break;
                default:
                    $sdkProduct = Mage::getModel('giveit/product_type_simple');
    ...
    protected function _getSdkProduct()
    {
        if (!$this->hasSdkProduct()) {
            $this->setSdkProduct(Mage::getModel('giveit/product_type_abstract'));
        }
    ...
    protected function isActive()
    {
        ...
        if ($isActive == GiveIt_Model_Product_Attribute_Source_Button_Active::BUTTON_ACTIVE_USE_CONFIG || $isActive === null) {
            $isActive = Mage::getStoreConfigFlag('giveit/button_settings/button_active');
        }
