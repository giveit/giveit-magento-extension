 ...
 *
 */
class GiveIt_Model_Giveit_Sale_Item_Product extends Mage_Core_Model_Abstract {
    ...
    public function setData($key, $value = null) {
        ...
        if (is_array($key) && array_key_exists(self::DETAILS_KEY, $key)) {
            $this->_details = Mage::getModel('giveit/giveit_sale_item_product_details');
     ...
     * Get product details
     *
     * @return GiveIt_Model_Giveit_Sale_Item_Product_Details
     */
